  ...
  Widget failedItemBuilder(BuildContext context) {
    return Center(
      child: ScaleText(
        ...
        style: const TextStyle(fontSize: 18, fontFamily: "Noto_Sans_JP"),
  ...
  Widget iOSPermissionOverlay(BuildContext context) {
      ...
      child: Column(
        ...
        children: <Widget>[
          ScaleText(
            ...
            style: const TextStyle(fontSize: 22, fontFamily: "Noto_Sans_JP"),
            textAlign: TextAlign.center,
    ...
    final Widget goToSettingsButton = MaterialButton(
      ...
      child: ScaleText(
        ...
        style: const TextStyle(fontSize: 17, fontFamily: "Noto_Sans_JP"),
    ...
    final Widget accessLimitedButton = GestureDetector(
      ...
      child: ScaleText(
        ...
        style: TextStyle(
            color: interactiveTextColor(context), fontFamily: "Noto_Sans_JP"),
    ...
    return Container(
      ...
      child: Padding(
        ...
        child: ScaleText(
          ...
          style: const TextStyle(fontSize: 16, fontFamily: "Noto_Sans_JP"),
